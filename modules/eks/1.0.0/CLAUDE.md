...
`terraform-aws-modules/eks/aws` v21.22.0 (2026-05-28 기준 최신; registry 최신은 v21.23.0이나 현재 버전 고정 유지)
...
EKS 클러스터, 시스템 노드 그룹, bootstrap addon(vpc-cni, kube-proxy, coredns) 5종을
